      ...
      {open && (
        <div className="absolute inset-0 flex items-center justify-center z-30">
          ...
          <div className="bg-white p-6 rounded-xl text-black w-[400px] z-40">
            <input placeholder="Title" onChange={e => setTitle(e.target.value)} className="w-full mb-2 p-2 border rounded" />
            <textarea placeholder="Description" onChange={e => setDescription(e.target.value)} className="w-full mb-2 p-2 border rounded" />

            <select onChange={e => setImportance(e.target.value)} className="w-full mb-4 p-2 border rounded">
      ...
      {editTask && (
        <div className="absolute inset-0 flex items-center justify-center z-30">
          ...
          <div className="bg-white p-6 rounded-xl text-black w-[400px] z-40">
            ...
            <button onClick={handleUpdateTask} className="bg-green-500 text-white p-2 w-full mb-2 rounded">
              Save
            </button>

            <button onClick={() => handleDelete(editTask._id)} className="bg-red-500 text-white p-2 w-full mb-2 rounded">
              Delete
            </button>

            <button onClick={() => setEditTask(null)} className="w-full p-2 border rounded">
              Close
            </button>
